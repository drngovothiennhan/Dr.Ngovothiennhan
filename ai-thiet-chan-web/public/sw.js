const CACHE='ai-thiet-chan-v2.5.1';
const SHELL=['/','/styles.css','/history.css','/dual-view.css','/settings.css','/app.js','/settings.js','/manifest.webmanifest','/icon.svg','/open-source.html'];
